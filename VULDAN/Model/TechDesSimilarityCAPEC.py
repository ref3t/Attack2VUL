...
neg_df = pd.read_excel('./datasets/TechData/ALLAttackPatterns.xlsx', engine='openpyxl')
...
neg_techIDs = neg_df['CAPECID'].tolist()
neg_descriptions = neg_df['CAPECDescription'].tolist()
...
filtered_similarity_df.to_excel('filtered_technique_similarity_scores_with_CAPEC70Per.xlsx')
