...
informationData = ["Procedures"] 

for mod in SentenceTransformersModels:
    allLinksFile = "./dataset/filterProc.xlsx"
    ...
    for infoData in informationData:
        ...
        print(model)
        dataframeResultsForallModels.to_excel(f"./Results/AllModelsJaccardBalanceImbalancedProc.xlsx", index=False)
