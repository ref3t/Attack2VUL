...
unique_positive_techniques = positive_df['TechnqiueID'].nunique()
...
final_df = pd.DataFrame(balanced_data, columns=['TechnqiueID', 'TechnqiueName', 'TechnqiueDescription', 'CVEID', 'CVEDescription', 'Label'])
...
train_data.to_excel('Tech_train_data.xlsx', index=False)
val_data.to_excel('Tech_val_data.xlsx', index=False)
test_data.to_excel('Tech_test_data.xlsx', index=False)
