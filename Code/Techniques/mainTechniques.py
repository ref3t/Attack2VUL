...
# informationData = ["Tactic", "TacticImBalanced","Procedures","ProceduresImBalanced"] 
...
for mod in SentenceTransformersModels:
    ...
    for infoData in informationData:
        ...
        print(model)
        dataframeResultsForallModels.to_excel(f"./Results/AllModelsJaccardBalanceImbalanced.xlsx", index=False)
