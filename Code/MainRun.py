...
informationData = ["Tactic", "Technique", "Procedure", "CAPEC", "TacticImbalanced", "TechniqueImbalanced", "ProcedureImbalanced", "CAPECImbalanced"]
...
for infoData in informationData:
    if infoData == "TacticImbalanced":
        ...
        # Save to Excel files
        train_file = 'dataset/attackInfo/Tactics/Tactic_train_data.xlsx'
        val_file = 'dataset/attackInfo/Tactics/Tactic_val_data.xlsx'
        test_file = 'dataset/attackInfo/Tactics/Tactic_test_data.xlsx'
    elif infoData == "Procedure":
        # Save to Excel files
        train_file = 'dataset/attackInfo/Procedures/Procedure_train_data.xlsx'
        val_file = 'dataset/attackInfo/Procedures/Procedure_val_data.xlsx'
        test_file = 'dataset/attackInfo/Procedures/Procedure_test_data.xlsx'
    ...
    for model_name in SentenceTransformersModels:
       ...
       # Define loss function
        ...
        print(model)
        dataframeResultsForallModels.to_excel(f"./Results/AllModelsJaccardNFineTuned.xlsx", index=False)
        dataframeResults.to_excel(f"Results/AllModelsResultsFinetuned.xlsx", index=False)
